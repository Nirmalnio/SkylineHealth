...
//               className="relative"
//               onClick={() => {
//                 isServicesOpen ? setIsServicesOpen(false) : setIsServicesOpen(true)
//               }}
//             >
//               {/* <a href='/home-care'> */}
              ...
              <AnimatePresence>
                {isServicesOpen && (
                  <motion.div
                    ...
                    className="absolute -left-20 top-10 mt-2 bg-white shadow-xl rounded-lg border p-6 flex space-x-12 z-50 w-[900px]"
                  >
                    {/* Services Column */}
                    <div className="flex flex-col space-y-4 w-1/2">
                      <h3 className="font-semibold text-lg">
                    ...
                    <div className="relative w-1/2 rounded-lg overflow-hidden shadow-md">
                      <img
                        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSrZetxZEK9gZl9U8Hs-a8eyfpU2bDoprBRgA&s"
                        alt="Staffing Support"
                        className="object-cover w-full h-full"
                      />
                      <div className="absolute bottom-0 left-0 right-0 bg-black bg-opacity-60 text-white p-4">
                ...
                <AnimatePresence>
                  {isServicesOpen && (
                    <motion.div
                      ...
                      exit="exit"
                      variants={dropdownVariants}
                      className="ml-4 mt-2 space-y-2 text-gray-600 flex-col"
                    >
                      <ul className="flex-col space-y-3">
                        {[
                          "alzheimers",
