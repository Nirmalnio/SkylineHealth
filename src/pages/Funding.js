...
import { FaHome, FaHandHoldingHeart, FaUniversity, FaLightbulb, FaArrowDown } from "react-icons/fa";
          ...
          >
            ...
            <div className="hidden lg:block">
              <div className="flex justify-between items-start relative">
                  ...
                  return (
                    ...
                    >
                      <motion.div
                        ...
                        animate={isActive ? { boxShadow: "0 20px 40px rgba(0,0,0,0.15)" } : {}}
                      >
                ...
                {/* Connecting arrows */}
                <svg className="absolute top-1/2 left-0 w-full h-20 pointer-events-none" style={{ zIndex: -1 }}>
                  <motion.path
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 mb-2">
                        Many start by paying privately and apply for council funding once their savings drop below{" "}
                        <motion.span
                      ...
                      <p className="text-gray-600 italic text-sm">
                        Your home won't count in the financial assessment if you're living in it.
                      </p>
                    </div>
                  </div>
                </motion.div>
