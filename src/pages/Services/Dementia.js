...
export default function DementiaAlzheimerCarePage() {
  ...
  const careSupport = [
    ...
    },
    {
      ...
      description: "Dedicated respite services and support for family carers who need a break",
    },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            >
              ...
              />
              <motion.div
                className="absolute bottom-8 right-4 w-1.5 h-1.5 bg-purple-400/30 rounded-full"
                animate={{ 
                  y: [-2, -8, -2],
                  x: [0, -3, 0],
                  opacity: [0.4, 0.9, 0.4]
            ...
            >
              ...
              />
              <motion.div
                className="absolute bottom-6 right-6 w-1 h-1 bg-blue-400/40 rounded-full"
                animate={{ 
                  scale: [1, 1.8, 1],
                  opacity: [0.4, 0.9, 0.4]
                }}
            ...
            >
              ...
              >
                ...
                <p className="text-lg opacity-90 leading-relaxed mb-6">
                  Every person's experience with Dementia or Alzheimer's is unique. Our carers 
      ...
      >
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <motion.div 
              className="bg-gradient-to-br from-[#FFDFDF] to-pink-100 p-8 rounded-2xl max-w-4xl mx-auto"
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl opacity-90 max-w-4xl mx-auto">
              All our live-in carers are trained in Dementia and Alzheimer's care, understanding 
